...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
    <div class="container">
      <a class="navbar-brand" href="#">HijabByMe</a>
      <button
...
<!-- article end -->
 ...
 <footer id="footer" class="text-center p-5">
  <div>
    <a href="https://www.instagram.com/bilqiisnabilaa_"
      ><i class="bi bi-instagram h2 p-2"></i
    ></a>
    <a href="https://twitter.com/billa"
      ><i class="bi bi-twitter h2 p-2"></i
    ></a>
    <a href="https://wa.me/+6285879229839"
      ><i class="bi bi-whatsapp h2 p-2"></i
    ></a>
  </div>
  <div>Isyeh Salma Bilqis Nabila &copy; 2024</div>
</footer>
<!-- footer end -->
